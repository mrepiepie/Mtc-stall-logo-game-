...
const newCorrect = `<CheckCircle2 className="w-16 h-16 sm:w-20 sm:h-20 text-black mb-4 sm:mb-6" />
                        <div className="text-4xl sm:text-5xl font-black uppercase tracking-tighter text-black mb-4 sm:mb-6">Correct</div>
                        {jokeContent && (
                          <div className="flex items-center gap-3 sm:gap-4 text-lg sm:text-xl font-black text-black bg-white px-6 sm:px-8 py-3 sm:py-4 rounded-none border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] mx-4 text-center uppercase">
                            {jokeContent.text}
                            <img src={jokeContent.emoji} className="w-10 h-10 sm:w-12 sm:h-12 drop-shadow-sm flex-shrink-0" alt="emoji" />
                          </div>
                        )}`;
...
console.log('Brutalized correct and wrong screens!');
