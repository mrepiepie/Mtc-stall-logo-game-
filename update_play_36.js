...
const oldCorrectBlock = `                  {gameStatus === 'correct' && (
...
const newCorrectBlock = `                  {gameStatus === 'correct' && (
                      <div className="absolute inset-0 bg-[#f4f0e6]/90 backdrop-blur-sm flex flex-col items-center justify-center z-20 animate-in fade-in duration-200">
...
const oldWrongBlock = `                    {gameStatus === 'wrong' && (
                      <div className="absolute inset-0 bg-[#f4f0e6]/90 backdrop-blur-sm flex flex-col items-center justify-center z-20 animate-in fade-in duration-200">
...
const newWrongBlock = `                    {gameStatus === 'wrong' && (
                      <div className="absolute inset-0 bg-[#f4f0e6]/90 backdrop-blur-sm flex flex-col items-center justify-center z-20 animate-in fade-in duration-200">
...
code = code.replace(normalize(oldCorrectBlock), normalize(newCorrectBlock));
code = code.replace(normalize(oldWrongBlock), normalize(newWrongBlock));

fs.writeFileSync('src/app/play/page.tsx', code);
console.log('Fixed Correct and Wrong overlays!');
